...
void LogInWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->logInSuccessful((*reinterpret_cast< std::add_pointer_t<std::shared_ptr<Account>>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LogInWindow::backButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LogInWindow::*)();
            if (_t _q_method = &LogInWindow::logInButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (LogInWindow::*)(std::shared_ptr<Account> );
...
// SIGNAL 0
void LogInWindow::backButtonClicked()
{
...
// SIGNAL 2
void LogInWindow::logInSuccessful(std::shared_ptr<Account> _t1)
{
