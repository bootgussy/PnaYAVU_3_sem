...
constexpr auto qt_meta_stringdata_CLASSManagerWindowENDCLASS = QtMocHelpers::stringData(
    "ManagerWindow",
    "logOutButtonClicked",
    ""
);
...
void ManagerWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ManagerWindow::*)();
            if (_t _q_method = &ManagerWindow::logOutButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ManagerWindow::logOutButtonClicked()
{
