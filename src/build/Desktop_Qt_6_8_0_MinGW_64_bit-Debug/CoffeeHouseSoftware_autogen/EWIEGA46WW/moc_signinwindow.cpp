...
Q_CONSTINIT const QMetaObject SignInWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSignInWindowENDCLASS_t,
        ...
        // method 'signInButtonClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'signInSuccessful'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<std::shared_ptr<Account>, std::false_type>
    >,
    nullptr
} };
...
void SignInWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->signInSuccessful((*reinterpret_cast< std::add_pointer_t<std::shared_ptr<Account>>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SignInWindow::backButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SignInWindow::*)();
            if (_t _q_method = &SignInWindow::signInButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SignInWindow::*)(std::shared_ptr<Account> );
            if (_t _q_method = &SignInWindow::signInSuccessful; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SignInWindow::backButtonClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SignInWindow::signInButtonClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SignInWindow::signInSuccessful(std::shared_ptr<Account> _t1)
{
