...
struct qt_meta_stringdata_CLASSMarqueeLabelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMarqueeLabelENDCLASS = QtMocHelpers::stringData(
    "MarqueeLabel",
    "updatePosition",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMarqueeLabelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MarqueeLabel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMarqueeLabelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMarqueeLabelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMarqueeLabelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *MarqueeLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMarqueeLabelENDCLASS.stringdata0))
